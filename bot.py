...
#On Ready
#Sends info that the bot is ready
@bot.event
async def on_ready():
...
#Command = !start
#Explains what the bots does and its commands
...
#Command = !new_project
#Makes a new project and adds a status of the project
